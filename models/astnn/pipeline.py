...
class Pipeline:
    ...
    def split_data(self):
        ...
        self.train_file_path = os.path.join(self.dest, 'train_.pkl')
        train.to_pickle(self.train_file_path)

        self.dev_file_path = os.path.join(self.dest, 'dev_.pkl')
        dev.to_pickle(self.dev_file_path)

        self.test_file_path = os.path.join(self.dest, 'test_.pkl')
    ...
    def dictionary_and_embedding(self, input_file, size):
        ...
        from models.astnn.prepare_data import get_sequences
        ...
        w2v.save(os.path.join(self.dest, 'embedding/node_w2v_' + str(size)))

    # generate block sequences with index representations
    def generate_block_seqs(self,data_path,part):
        from models.astnn.prepare_data import get_blocks as func
        from gensim.models.word2vec import Word2Vec

        word2vec = Word2Vec.load(os.path.join(self.dest, 'embedding/node_w2v_' + str(self.size))).wv
        ...
        trees.to_pickle(os.path.join(self.dest, part+'_blocks.pkl'))
